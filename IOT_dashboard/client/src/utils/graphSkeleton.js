...
const GraphSkeleton = () => {
  return (
    ...
    <div>
          <div className="dashboard-container" style={{width:"100%", height:"100%" , justifyContent:"center",display:"flex",marginTop:20}}>
            ...
            <div className="line-graph" style={{ justifyContent:"center",display:"flex",borderRadius:"20px",height:"30%",justifyContent:"center",marginTop:30}}>
